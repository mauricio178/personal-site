...
export default function Home() {
  ...
  // <script>window.rwbp={email: 'mauricio.log98@hotmail.com', phone:'5561982243585',message:'Olá! Tenho interesse em trabalhar com você, vamos nessa?',lang:'pt-BR'}</script><script defer async src='https://duz4dqsaqembt.cloudfront.net/client/whats.js'></script>
